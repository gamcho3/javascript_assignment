...
const showQuote1 = (quotes, authors) => {
  document.write(`<p style="color: aqua;">${authors[0]} : ${quotes[0]}</p>`);
};
const showQuote2 = (quotes, authors) => {
  document.write(`<p style="color: red;">${authors[1]} : ${quotes[1]}</p>`);
};
const showQuote3 = (quotes, authors) => {
  document.write(`<p style="color: blue;">${authors[2]} : ${quotes[2]}</p>`);
};

showQuote1(quotes, authors);
showQuote2(quotes, authors);
showQuote3(quotes, authors);
